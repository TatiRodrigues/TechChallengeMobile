...
Os cartões de **Entradas**, **Saídas** e **Saldo** somam apenas as transações já carregadas na tela, com os filtros atuais aplicados. Se houver mais páginas disponíveis, carregue-as com **Carregar mais transações** para que os totais reflitam todo o conjunto filtrado.
